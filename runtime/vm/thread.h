...
class Thread : public ThreadState {
 public:
  ...
  // Offset of the Dart Extension StreamInfo object.
  static intptr_t extension_stream_offset() {
    return OFFSET_OF(Thread, extension_stream_);
  }
