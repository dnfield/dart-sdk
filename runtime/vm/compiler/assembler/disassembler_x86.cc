...
int DisassemblerX64::InstructionDecode(uword pc) {
  ...
  if (!processed) {
    switch (*data) {
      ...
      case 0xD1:  FALL_THROUGH
      case 0xD3:  FALL_THROUGH
      case 0xC1:
        data += ShiftInstruction(data);
        break;
      case 0xD0:  FALL_THROUGH
      case 0xD2:  FALL_THROUGH
      case 0xC0:
        byte_size_operand_ = true;
        data += ShiftInstruction(data);
        break;

      case 0xD9:  FALL_THROUGH
      case 0xDA:  FALL_THROUGH
      case 0xDB:  FALL_THROUGH
      case 0xDC:  FALL_THROUGH
      case 0xDD:  FALL_THROUGH
      case 0xDE:  FALL_THROUGH
      case 0xDF:
